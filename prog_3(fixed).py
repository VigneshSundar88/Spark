...
class parse_file():
    def __init__(self):
        self.fixed_length_schema = "/FileStore/tables/fixed_data.csv"
        self.fixed_length_file = "/FileStore/tables/fixed_length_file.txt"
    ...
    def substr_file(self, read_fixed_schema, read_fixed_length_file):
        ...
        create_sub_df.write.mode('overwrite').saveAsTable("parsed_tbl")
        df_select = spark.sql("select * from parsed_tbl").show()
